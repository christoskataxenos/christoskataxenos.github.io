...
const FileTree = ({ children }) => {
  return (
    <div className="file-tree my-6 rounded-lg border border-gray-800 bg-black/30 p-4 font-mono text-[12px] sm:text-[13px] text-gray-300 shadow-inner leading-snug">
      <style jsx>{`
